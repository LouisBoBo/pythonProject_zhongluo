...
# -*- coding: utf-8 -*-
"""
打包 Dify 约束规则数据库节点（参照 insert_mes_data_todb.py 连接方式）：

  python3 build_mes_sql_rules_db_bundle.py
"""
...
CORE = ROOT / "mes_sql_rules_db.py"
READ_OUT = ROOT / "dify_mes_sql_rules_db_read.py"
WRITE_OUT = ROOT / "dify_mes_sql_rules_db_write.py"
